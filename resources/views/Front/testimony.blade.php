...
<div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="{{asset('chari/index.html')}}" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="fw-bold text-primary m-0">WhiteRibbon<span class="text-white">Gh</span></h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-none d-lg-flex ms-2">
                <a class="btn btn-outline-primary py-2 px-3" href="{{route('front.donate')}}">
                    Donate Now
                    <a href="{{route('front.donate')}}"  class="btn btn-outline-primary py-2 px-3">Donate</a>
