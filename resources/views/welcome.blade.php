            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="{{asset('chari/service.html')}}" class="dropdown-item">Service</a>
                        <a href="{{asset('chari/donate.html')}}" class="dropdown-item">Donate</a>
                        <a href="{{asset('chari/team.html')}}" class="dropdown-item">Our Team</a>
                        <a href="{{asset('chari/testimonial.html')}}" class="dropdown-item">Testimonial</a>
                        <a href="{{asset('chari/404.html')}}" class="dropdown-item">404 Page</a>
                    </div>
                </div>
                <a href="{{asset('chari/contact.html')}}" class="nav-item nav-link">Contact</a>
            </div>
    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="{{asset('chari/img/carousel-1.jpg')}}" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="{{asset('chari/img/carousel-2.jpg')}}" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 pt-5">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100">
                    ...
                    <div class="position-relative mt-auto">
                        <img class="img-fluid" src="{{asset('chari/img/courses-1.jpg')}}" alt="">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100">
                    ...
                    <div class="position-relative mt-auto">
                        <img class="img-fluid" src="{{asset('chari/img/courses-2.jpg')}}" alt="">
                        <div class="causes-overlay">
                            <a class="btn btn-outline-primary" href="">
                                Read More
                                <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100">
                    ...
                    <div class="position-relative mt-auto">
                        <img class="img-fluid" src="{{asset('chari/img/courses-3.jpg')}}" alt="">
                        <div class="causes-overlay">
                            <a class="btn btn-outline-primary" href="">
                                Read More
                                <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item position-relative rounded overflow-hidden">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="{{asset('chari/img/team-1.jpg')}}" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item position-relative rounded overflow-hidden">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="{{asset('chari/img/team-2.jpg')}}" alt="">
                    </div>
                    <div class="team-text bg-light text-center p-4">
                        <h5>Full Name</h5>
                        <p class="text-primary">Designation</p>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item position-relative rounded overflow-hidden">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="{{asset('chari/img/team-3.jpg')}}" alt="">
                    </div>
                    <div class="team-text bg-light text-center p-4">
                        <h5>Full Name</h5>
                        <p class="text-primary">Designation</p>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item position-relative rounded overflow-hidden">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="{{asset('chari/img/team-4.jpg')}}" alt="">
                    </div>
                    <div class="team-text bg-light text-center p-4">
                        <h5>Full Name</h5>
                        <p class="text-primary">Designation</p>
...
{{--<script src="{{asset('chari/https://code.jquery.com/jquery-3.4.1.min.js')}}"></script>--}}
